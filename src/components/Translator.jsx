...
function Translator() {
  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col items-center justify-center pb-[70px] text-white px-10 max-sm:px-6">
        <div className="flex w-full justify-center mb-10 max-sm:mb-0">
          <img
            src={logo}
            alt=""
            className="w-[300px] h-auto max-md:w-[150px] max-md:my-6"
          />
        </div>
        <div className="w-full h-[650px] max-md:h-[500px] flex gap-10 max-md:gap-4 max-lg:flex-col">
